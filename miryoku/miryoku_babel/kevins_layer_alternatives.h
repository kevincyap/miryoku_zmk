...
&kp ESC,           &kp Q,             &kp W,             &kp E,             U_MT(T, R),          &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
&kp TAB,           &kp A,             &kp S,             &kp D,             U_MT(G, F),          &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT), \
&kp LSHFT,         &kp Z,             &kp X,             &kp C,             U_MT(B, V),          &kp N,             &kp M,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),         \

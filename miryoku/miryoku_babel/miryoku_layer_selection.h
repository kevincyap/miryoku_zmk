...
#include "kevin_layer_alternatives.h"
    ...
    #else
      #define MIRYOKU_LAYER_BASE KEVIN_MAP_QWERTY
    #endif
  #endif
#endif
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (KEVIN_EXTRA_ARTSEY)
      #define MIRYOKU_LAYER_EXTRA KEVIN_MAP_ARTSEY
    #else
      #define MIRYOKU_LAYER_EXTRA KEVIN_MAP_DVORAK
    #endif
  #endif
#endif
  ...
  #define MIRYOKU_LAYER_BUTTON KEVIN_MAP_BUTTON
#endif
  ...
  #define MIRYOKU_LAYERMAPPING_BUTTON MIRYOKU_MAPPING
    ...
    #else
      #define MIRYOKU_LAYER_NAV KEVIN_MAP_NAV
    #endif
  #endif
#endif
  ...
  #define MIRYOKU_LAYERMAPPING_MOUSE MIRYOKU_MAPPING
    ...
    #else
      #define MIRYOKU_LAYER_MEDIA KEVIN_MAP_MEDIA
    #endif
  #endif
#endif
  ...
  #else
    #define MIRYOKU_LAYER_NUM KEVIN_MAP_NUM
  #endif
#endif
  ...
  #else
    #define MIRYOKU_LAYER_SYM KEVIN_MAP_SYM
  #endif
#endif
  ...
  #else
    #define MIRYOKU_LAYER_FUN KEVIN_MAP_FUN
  #endif
#endif
